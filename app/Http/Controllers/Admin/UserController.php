...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'password' => 'required|string|min:6|confirmed',  // A validação de confirmação de senha
            'role' => 'required|in:admin,professor,estudante,candidato',
            'numero_matricula' => 'nullable|string|max:255',
            'bilhete' => 'nullable|string|max:255',
